...
if ($VmAction.Equals("Start")) {
    ...
    Get-AzVm -ResourceGroupName jmcdonough-ap-elb-ilb-az-west-us2-01 | Start-AzVm -NoWait
    ...
    Get-AzVm -ResourceGroupName jmcdonough-ap-elb-ilb-az-west-us2-01 | Stop-AzVm -NoWait -Force
}
